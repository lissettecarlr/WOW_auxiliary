...
class ToolsUi(QDialog):
    ...
    def __init__(self, num):
        ...
        self.comboBox_sd = QtWidgets.QComboBox()
        ...
        self.comboBox_data = QtWidgets.QComboBox()
        ...
        self.v_box_send_top = QHBoxLayout()
        ...
        self.comboBox_data.addItem("以字符串显示")
        self.comboBox_data.addItem("以ascii码显示")

        self.comboBox_sd.addItem("输入的是字符串")
        self.comboBox_sd.addItem("输入的是hex")
    ...
    def layout_ui(self):
        ...
        self.v_box_send_top.addWidget(self.label_send)
        self.v_box_send_top.addWidget(self.comboBox_sd)
        self.v_box_send.addLayout(self.v_box_send_top)
        ...
        #self.v_box_left.addLayout(self.v_box_send_top)
        ...
        self.v_box_right.addWidget(self.comboBox_data) 
    ...
    def ui_translate(self):
        ...
        self.setWindowTitle(self._translate("TCP-UDP", "网络测试工具-窗口%s" % self.num))
        ...
        self.pushButton_else.setText(self._translate("TCP-UDP", "点击窗口多开"))
        ...
        self.lineEdit_port.setValidator(QtGui.QIntValidator())
        #self.label_written.setText(self._translate("TCP-UDP", "python+pyqt5"))
